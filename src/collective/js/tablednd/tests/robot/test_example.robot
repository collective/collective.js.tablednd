...
#
#  $ bin/test -s collective.js.tablednd -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src collective.js.tablednd.testing.COLLECTIVE_JS_TABLEDND_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
